    ...
    <div className="flex flex-col gap-4">
      <header className="flex flex-col gap-1">
        ...
        <p className="text-sm text-muted-foreground">
          Powered by Vercel AI SDK. Provider via env (your AI provider recipe sets this up).
          Replace this raw markup with{' '}
          <a
          ...
          components when you want richer chat primitives.
        </p>
      </header>
